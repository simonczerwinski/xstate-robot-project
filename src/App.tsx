...
const App: React.FC = () => {
	return (
		<MasterLayout>
			<header className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0">
				<h1 className="text-2xl font-bold text-white">
					Welcome to my Robot Project
				</h1>
			</header>
			<div className="bg-gray-200 py-4 flex flex-col items-center">
